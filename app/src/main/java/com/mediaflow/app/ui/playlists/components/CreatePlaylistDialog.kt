...
fun CreatePlaylistDialog(
    ...
    val isError = name.isNotBlank() && name.trim().length > 60
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(
                    text = "Introduce un nombre para organizar tu música y Spaces.",
                ...
                OutlinedTextField(
                    ...
                    supportingText = if (isError) {
                        { Text("El nombre es demasiado largo (máx 60 caracteres)") }
                    } else null,
                    modifier = Modifier
                        .fillMaxWidth()
