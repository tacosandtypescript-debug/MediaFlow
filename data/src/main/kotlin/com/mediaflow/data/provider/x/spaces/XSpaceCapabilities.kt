...
data class XSpaceStreamInfo(
    ...
    companion object {
        fun fromPlaybackUrl(url: String?, spaceEnded: Boolean): XSpaceStreamInfo {
            ...
            // Replay HLS is VOD-like seek. Live seek requires an explicit DVR window.
...
data class XSpaceCapabilities(
    ...
    /** True only when live AND a real remote-DVR window was observed. */
    ...
    companion object {
        ...
        fun from(
            ...
            val fields = linkedMapOf(
                ...
                FIELD_HOST to present(space.host.username.isNotBlank() || space.host.displayName.isNotBlank()),
